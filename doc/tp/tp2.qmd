...
::: {.callout-important}
During the first tutorial, you created a repository using template [ENSAI-2A-Java-TP repository](https://github.com/ludo2ne/ENSAI-2A-Java-TP){target="_blank"}, i.e. you created a copy of this repository on GitHub.

If the original repository has been updated, so you need to synchronise your fork with the latest version of the repository.
:::
...
- [ ] Fetch the latest changes from upstream and merge the main branch
