...
When you've finished, don't forget to pause or delete your service.
...
::: {.callout-important}
During the first tutorial, you created a repository from the template [ENSAI-2A-Java-TP repository](https://github.com/ludo2ne/ENSAI-2A-Java-TP){target="_blank"}. This means you created your own copy of this repository on GitHub.

If the original repository has been updated since then, you need to synchronise your repository with the latest version.
:::
...
- [ ] Fetch the latest changes from the original repository and merge the `main` branch
...
- [ ] File > Open Folder > tp2
  - or using: `code-server ~/work/ENSAI-2A-Java-TP/tp2/`
...
- [ ] Fix the code, adding a new constructor for Author
- [ ] Commit and push
