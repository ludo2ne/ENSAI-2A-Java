...
- [ ] During container startup, copy the link where your application will be exposed (port 5000)
...
- [ ] If necessary in the terminal, change current directory to tp5
...
- `https://user-<sspcloud_username>-<6digits_number>-user.user.lab.sspcloud.fr/`
