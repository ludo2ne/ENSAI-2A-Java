---
title: "Advanced Java"
description: "[Slides](07-advanced-slides.html)"
...
format: 
  ...
  revealjs:
    theme: moon
    footer: "[Home](../../index.html) --- [Advanced Java](07-advanced.html)"
    slide-number: c/t                    ## collapsed/total
    slide-level: 3
    controls: true
    output-file: 07-advanced-slides.html
from: markdown+emoji
lightbox: true
categories:
  - Exceptions
...
When the :train: leaves the tracks, you must decide how to react:
