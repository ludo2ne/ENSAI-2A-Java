...
description: "[Slides](08-spring-slides.html)"
format: 
  html: default
  revealjs:
    footer: "[Home](../../index.html) --- [Spring](08-spring.html)"
    output-file: 08-spring-slides.html
mermaid:
  theme: neutral
categories:
  - Spring Boot
...
### :pizza: status codes {.smaller}

- 200 OK: Your pizza order was accepted and delivered successfully
- 400 Bad Request: You ordered something invalid (e.g., "a pizza in PDF format")
- 401 Unauthorized: You must log in before ordering pizza
- 403 Forbidden: You are logged in, but you're not allowed to order (e.g., kitchen is staff-only)
- 404 Not Found: You ordered a pizza that doesn't exist on the menu
- 500 Internal Server Error: The kitchen messed up while preparing your pizza
...
:::{.notes}
- recursive acronym
  - basically means: "We definitely don’t want to be XML.""
...
- quotes: often optional unless the string contains special characters
:::
...
Dependancy Injection: 
  - Spring automatically creates an implementation of the Repository interface
  - and injects a proxy instead.
:::
